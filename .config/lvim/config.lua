...
vim.keymap.set('n', '<tab>m', M.split_left)
vim.keymap.set('n', '<tab>i', M.split_right)
vim.keymap.set('n', '<tab>n', M.split_bottom)
vim.keymap.set('n', '<tab>e', M.split_top)
